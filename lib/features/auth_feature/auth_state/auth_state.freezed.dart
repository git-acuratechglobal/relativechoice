...
mixin _$AuthState {
  ...
  double? get formProgress => throw _privateConstructorUsedError;
...
abstract class $AuthStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({AuthEvent authEvent, String? response, double? formProgress});
}
...
class _$AuthStateImpl implements _AuthState {
  const _$AuthStateImpl(
      {required this.authEvent, this.response, this.formProgress});
  ...
  @override
  String toString() {
    return 'AuthState(authEvent: $authEvent, response: $response, formProgress: $formProgress)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, authEvent, response, formProgress);
...
abstract class _AuthState implements AuthState {
  const factory _AuthState(
      ...
      final String? response,
      final double? formProgress}) = _$AuthStateImpl;
