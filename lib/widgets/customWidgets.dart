...
import 'package:relative_choice/widgets/linear_progress_bar.dart';
      ...
      child: Row(children: [
        IconButton(
            onPressed: () {
              ...
              ref.read(pageControllerProvider.notifier).state.previousPage(
      ...
      child: Row(children: [
        IconButton(
            onPressed: () {
              ...
              ref.read(pageControllerProvider2.notifier).state.previousPage(
                  duration: Duration(microseconds: 500),
                  curve: Curves.bounceIn);
      ...
      child: Row(children: [
        IconButton(
            onPressed: () {
              ...
              ref.read(pageControllerProvider3.notifier).state.previousPage(
                  duration: Duration(microseconds: 500),
                  curve: Curves.bounceIn);
